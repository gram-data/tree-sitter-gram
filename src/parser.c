...
enum ts_symbol_identifiers {
  ...
  sym__backticked_string = 65,
  sym__fenced_string = 66,
  sym__fenced_string_body = 67,
  sym_tagged_string = 68,
  sym__relationship_kind = 69,
  sym_undirected_arrow = 70,
  sym_right_arrow = 71,
  sym_left_arrow = 72,
  sym_bidirectional_arrow = 73,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    [sym_gram] = STATE(135),
    [sym__open_bracket] = STATE(10),
    [sym__open_parens] = STATE(12),
    [sym__open_brace] = STATE(56),
    [sym_pattern] = STATE(3),
    [sym_pattern_element] = STATE(48),
    [sym_subject] = STATE(50),
    [sym_annotation] = STATE(9),
    [sym__path] = STATE(50),
    [sym_node] = STATE(13),
    [sym_relationship] = STATE(50),
    [sym__reference] = STATE(50),
    [sym__value] = STATE(50),
    [sym_record] = STATE(2),
    [sym_range] = STATE(50),
    [sym__numeric_literal] = STATE(44),
    [sym_string_literal] = STATE(50),
    [sym__single_quoted_string] = STATE(28),
    [sym__double_quoted_string] = STATE(26),
    [sym__backticked_string] = STATE(25),
    [sym__fenced_string] = STATE(27),
    [sym_tagged_string] = STATE(50),
    [aux_sym_gram_repeat1] = STATE(3),
    [aux_sym_pattern_element_repeat1] = STATE(9),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gram, 1, 0, 2),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gram, 1, 0, 0),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gram, 2, 0, 2),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0),
  [37] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(12),
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(140),
  [46] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(50),
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(67),
  ...
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(119),
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(117),
  [64] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(139),
  [67] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(77),
  ...
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tagged_string, 4, 0, 20),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tagged_string, 4, 0, 20),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fenced_string_body, 2, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__fenced_string_body, 2, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fenced_string, 2, 0, 5),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__fenced_string, 2, 0, 5),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 1, 0, 3),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 1, 0, 3),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tagged_string, 4, 0, 19),
  [128] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tagged_string, 4, 0, 19),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 2, 0, 9),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range, 2, 0, 9),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 2, 0, 4),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range, 2, 0, 4),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 3, 0, 18),
  [140] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range, 3, 0, 18),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__single_quoted_string, 3, 0, 11),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__single_quoted_string, 3, 0, 11),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fenced_string_body, 3, 0, 11),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__fenced_string_body, 3, 0, 11),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tagged_string, 5, 0, 25),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tagged_string, 5, 0, 25),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__double_quoted_string, 3, 0, 11),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__double_quoted_string, 3, 0, 11),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__backticked_string, 3, 0, 11),
  [160] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__backticked_string, 3, 0, 11),
  ...
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 2, 0, 0),
  [176] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern, 2, 0, 0),
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subject, 3, 0, 13),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subject, 3, 0, 13),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern_element, 2, 0, 10),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern_element, 2, 0, 10),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subject, 3, 0, 12),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subject, 3, 0, 12),
  ...
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_pattern_repeat1, 2, 0, 0),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern_element, 1, 0, 1),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern_element, 1, 0, 1),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relationship, 3, 0, 17),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relationship, 3, 0, 17),
  [214] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_pattern_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subject, 2, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subject, 2, 0, 0),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subject, 4, 0, 21),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subject, 4, 0, 21),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_pattern_element_repeat1, 2, 0, 0),
  [227] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_pattern_element_repeat1, 2, 0, 0), SHIFT_REPEAT(140),
  [230] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_pattern_element_repeat1, 2, 0, 0),
  ...
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_annotation, 5, 0, 24),
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_annotation, 5, 0, 24),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 1, 0, 6),
  [244] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [246] = {.entry = {.count = 1, .reusable = true}}, SHIFT(114),
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_labels, 1, 0, 0),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_labels_repeat1, 2, 0, 0),
  [252] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_labels_repeat1, 2, 0, 0), SHIFT_REPEAT(118),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 1, 0, 7),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 2, 0, 14),
  ...
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label, 2, 0, 0),
  ...
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 2, 0, 16),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 2, 0, 15),
  ...
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 3, 0, 22),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0),
  [303] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0), SHIFT_REPEAT(58),
  [306] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [308] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [310] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [312] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 1, 0, 8),
  [314] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [316] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_pattern_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  ...
  [351] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 3, 0, 23),
  ...
  [363] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bidirectional_arrow, 2, 0, 0),
  [365] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_undirected_arrow, 2, 0, 0),
  [367] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_right_arrow, 2, 0, 0),
  ...
  [387] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_left_arrow, 2, 0, 0),
  ...
  [397] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__association, 2, 0, 0),
  [399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_undirected_arrow, 5, 0, 26),
  [401] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_right_arrow, 5, 0, 26),
  [403] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_left_arrow, 5, 0, 26),
  [405] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bidirectional_arrow, 5, 0, 26),
