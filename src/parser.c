...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_annotations] = STATE(34),
    [sym_annotation] = STATE(19),
    [sym__path] = STATE(68),
    [sym_node] = STATE(21),
    [sym_relationship] = STATE(68),
    [sym_record] = STATE(23),
    [aux_sym_gram_repeat1] = STATE(25),
    [aux_sym_annotations_repeat1] = STATE(19),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(136)] = 2399,
  [SMALL_STATE(137)] = 2403,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_annotations_repeat1, 2, 0, 0),
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_annotations_repeat1, 2, 0, 0), SHIFT_REPEAT(140),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_annotations_repeat1, 2, 0, 0),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_annotations, 1, 0, 0),
  [58] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_annotations, 1, 0, 0),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_annotation, 5, 0, 28),
  [62] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_annotation, 5, 0, 28),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__path, 1, 0, 0),
  ...
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gram, 2, 0, 2),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gram, 1, 0, 2),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0),
  [84] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [87] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(140),
  [90] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_gram_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  ...
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_node, 2, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_node, 3, 0, 16),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_node, 3, 0, 11),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_node, 4, 0, 23),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 1, 0, 3),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ref_value, 1, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = false}}, SHIFT(63),
  [115] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tagged_string, 5, 0, 29),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 2, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(124),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 2, 0, 9),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fenced_string, 2, 0, 10),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_literal, 1, 0, 0),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 2, 0, 15),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_labels_repeat1, 2, 0, 0),
  [133] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_labels_repeat1, 2, 0, 0), SHIFT_REPEAT(155),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 3, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 1, 0, 6),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__single_quoted_string, 3, 0, 20),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__double_quoted_string, 3, 0, 20),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__backticked_string, 3, 0, 20),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fenced_string_body, 2, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 3, 0, 22),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_labels, 1, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 4, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tagged_string, 4, 0, 25),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tagged_string, 4, 0, 26),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fenced_string_body, 3, 0, 20),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subject, 2, 0, 0),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 2, 0, 7),
  [164] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subject, 3, 0, 11),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 2, 0, 8),
  [170] = {.entry = {.count = 1, .reusable = false}}, SHIFT(52),
  [172] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_pattern_repeat1, 2, 0, 0),
  [176] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_pattern_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 3, 0, 17),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relationship, 3, 0, 18),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subject, 4, 0, 19),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 1, 0, 1),
  [187] = {.entry = {.count = 1, .reusable = false}}, SHIFT(39),
  [189] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subject, 5, 0, 27),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__value, 1, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 2, 0, 12),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 1, 0, 4),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__label, 2, 0, 0),
  ...
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub_pattern, 2, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 2, 0, 13),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 3, 0, 21),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 2, 0, 14),
  ...
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub_pattern, 1, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attributes, 1, 0, 5),
  [241] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0),
  [246] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sub_pattern_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sub_pattern_repeat1, 2, 0, 0),
  [251] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [253] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [255] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [257] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(16),
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0),
  ...
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 3, 0, 24),
  ...
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_right_arrow, 2, 0, 0),
  ...
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bidirectional_arrow, 2, 0, 0),
  ...
  [362] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_undirected_arrow, 5, 0, 30),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_right_arrow, 5, 0, 30),
  [366] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_left_arrow, 5, 0, 30),
  [368] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bidirectional_arrow, 5, 0, 30),
  [370] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [372] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_undirected_arrow, 2, 0, 0),
